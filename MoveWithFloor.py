...
def boxes_dodged(count):
    ...
    counter = myFont.render("dodged: "+str(count), 1, (255, 255, 255))
    screen.blit(counter, (230, 380))
...
def main():
    ...
    while keepGoing:
        ...
        for event in pygame.event.get():
            ...
            counter = myFont.render("dodged: "+str(boxesdodged), 1, white)    
